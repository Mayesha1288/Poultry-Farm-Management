...
<form  action="{{route('admin.hens.store')}}" method="post"  enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input required name="weight" type="number" step="0.01" class="form-control" id="exampleInputPassword1" placeholder="Hen Weight">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Hen Price</label>
    <input  required name="price" type="number" class="form-control" id="exampleInputPassword1" placeholder="Hen Price">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Hen Quantity</label>
    <input required name="quantity" type="number" class="form-control" id="exampleInputPassword1" placeholder="">
  </div>
  <div class="form-group">
